...
`npm i delab-tonconnect-ui-react`
...
```tsx
import { useTonWallet } from 'delab-tonconnect-ui-react';
...
```tsx
import { useTonConnectModal } from 'delab-tonconnect-ui-react';
...
```tsx
import { Locales, useTonConnectUI } from 'delab-tonconnect-ui-react';
...
```tsx
import { useIsConnectionRestored } from 'delab-tonconnect-ui-react';
...
./node_modules/delab-tonconnect-ui/lib/esm/index.mjs
./node_modules/delab-tonconnect-ui-react/lib/esm/index.js
```
